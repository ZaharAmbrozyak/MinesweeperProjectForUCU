...
class Display:
    ...
    def __init__(self, game_settings: Settings, screen: pygame.surface.Surface,
        ...
        self.example_image = pygame.image.load('visuals/images/0.1.png').convert()
    ...
    def blit_display(self) -> None:
        ...
        self.screen.blit(pygame.image.load(f'visuals/images/{self.counter[0]}.1.png').convert(), self.rect1)
        self.screen.blit(pygame.image.load(f'visuals/images/{self.counter[1]}.1.png').convert(), self.rect2)
        self.screen.blit(pygame.image.load(f'visuals/images/{self.counter[2]}.1.png').convert(), self.rect3)
